...
ResultSet rs;
if(request.getParameter("oid")!=null && request.getParameter("opr").equals("DL"))
     {
        stmt=con.prepareStatement("Update orders set ostatus='Delivered' where oid=?");
    ...
    <body>        
        ...
        <div class="container">            
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <%
                        stmt=con.prepareStatement("Select * from Orders where ostatus='Shipped'");
                        ...
                        while(rs.next())
                        {
                            ...
                            out.write("<td>"+s4+"</td>");
                            out.write("<td>"+s5+"</td>");
                            out.write("<td><a href='shippedorder.jsp?opr=D&oid="+s1+"'>Show Details</a></td>");
                            out.write("<td><a href='shippedorder.jsp?opr=DL&oid="+s1+"'>Delivered</a></td>");                          
                            out.write("</tr>");
                        }
                    %>
                </tbody>

...
ResultSet rs;
if(request.getParameter("oid")!=null && request.getParameter("opr").equals("S"))
     {
        stmt=con.prepareStatement("Update orders set ostatus='Shipped' where oid=?");
    ...
    <body>        
        ...
        <div class="container">            
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <%
                        stmt=con.prepareStatement("Select * from Orders where ostatus='New'");
                        ...
                        while(rs.next())
                        {
                            ...
                            out.write("<td>"+s4+"</td>");
                            out.write("<td>"+s5+"</td>");
                            out.write("<td><a href='neworder.jsp?opr=D&oid="+s1+"'>Show Details</a></td>");
                            out.write("<td><a href='neworder.jsp?opr=S&oid="+s1+"'>Shipped</a></td>");                          
                            out.write("</tr>");
                        }
